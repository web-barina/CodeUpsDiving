...
<body>
  ...
  <header class="header">
    ...
    <div class="header__inner">
      <h1 class="header__logo"><a href="index.html"><img src="./assets/images/common/logo.png" alt="コードアップスのロゴ" /></a>
      </h1>
        ...
        <div class="top-voice__cards voice-cards">
          <a href="./voice.html" class="voice-cards__item voice-card">
            <div class="voice-card__info">
              ...
              <div class="voice-card__img js-color-box"><img src="./assets/images/common/voice1.png" alt="お客様女性の写真" />
              </div>
            </div>
          ...
          <a href="./voice.html" class="voice-cards__item voice-card">
            <div class="voice-card__info">
              ...
              <div class="voice-card__img js-color-box"><img src="./assets/images/common/voice2.png" alt="お客様男性の写真" />
              </div>
            </div>
            <p class="voice-card__text">
              ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。<br />
      ...
      <div class="top-price__inner inner">
        ...
        <div class="top-price__contents-wrapper">
          <picture class="top-price__img js-color-box">
            <source srcset="./assets/images/common/price-pc.png" media="(min-width: 768px)" type="image/jpg" />
        ...
        <div class="contact__content-inner">
          <div class="contact__address-wrapper">
            <div class="contact__info-wrapper">
              <div class="contact__logo logo"><img src="./assets/images/common/contact-logo.png" alt="コードアップスのロゴ" />
              </div>
            </div>
